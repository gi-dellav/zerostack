...
pub fn default_bash_rules() -> Vec<(&'static str, Action)> {
    vec![
        ...
        ("git rev-parse **", Action::Allow),
        ("git ls-tree", Action::Allow),
        ("git ls-tree **", Action::Allow),
        ("git ls-remote", Action::Allow),
        ("git ls-remote **", Action::Allow),
        ("git cat-file", Action::Allow),
        ("git cat-file **", Action::Allow),
        ("git blame", Action::Allow),
        ("git blame **", Action::Allow),
        ("git reflog", Action::Allow),
        ("git reflog **", Action::Allow),
        ("git tag", Action::Allow),
        ("git tag **", Action::Allow),
        ("git stash list", Action::Allow),
        ("git stash list **", Action::Allow),
        ...
        ("pixi run **", Action::Allow),
        ("pip list", Action::Allow),
        ("pip show **", Action::Allow),
        ("darcs **--diff-command**", Action::Deny),
        ("darcs **--prehook**", Action::Deny),
        ("darcs **--posthook**", Action::Deny),
        ("darcs annotate **", Action::Allow),
        ("darcs diff", Action::Allow),
        ("darcs diff **", Action::Allow),
        ("darcs log", Action::Allow),
        ("darcs log **", Action::Allow),
        ("darcs test", Action::Allow),
        ("darcs test **", Action::Allow),
        ("darcs show **", Action::Allow),
        ("darcs whatsnew", Action::Allow),
        ("darcs whatsnew **", Action::Allow),
        ("sudo", Action::Ask),
        ("sudo **", Action::Ask),
        ("rm -rf /**", Action::Deny),
